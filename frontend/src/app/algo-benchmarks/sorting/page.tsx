...
import { sortImplementations } from './sortImplementations'
import prettyMs from 'pretty-ms'
import { X, LineChart, Sparkles, Play, Loader, Braces } from 'lucide-react'

export default function Sorting() {
    // test settings
    const [numArray, setNumArray] = useState("2,5,9,7,4,3,1,8,10,6")
    ...
    const runTest = async () => {
        try {
            ...
            // initial request
            const response = await fetch(`${process.env.ORCHESTRATOR_PUBLIC_API_URL}/api/v1/algos/sort`, {
                method: 'POST',
                headers: {
    ...
    return (
        <div>
            <h1 className="text-3xl mb-8 text-white">Sorting Benchmarks</h1>
                        ...
                        <div className="flex flex-col">
                            <div className="grid grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-4 text-white">
                                        <div>
                                            <p className="font-medium">Array to Sort:</p>
                                        ...
                                        <div>
                                            <p className="font-medium">Sort Method:</p>
                            ...
                            <div className="flex flex-row justify-start gap-4 py-16 pb-0">
                                ...
                                <CodeModal
                                    ...
                                    codeContent={sortImplementations[algorithm][language]}
                                />
                                {/* run testy */}
                                <button
                                    onClick={runTest}
